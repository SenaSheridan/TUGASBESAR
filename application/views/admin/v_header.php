...
<header class="main-header">
    ...
    <a href="" class="logo">
      ...
      <span class="logo-mini"><img width="40px" src="<?php echo base_url().'assets/images/trisigma_logo.png'?>" alt="" srcset=""></span>
      <!-- logo for regular state and mobile devices -->
      <span class="logo-lg"><img width="40px" src="<?php echo base_url().'assets/images/trisigma_logo.png'?>" alt="" srcset=""> TRISIGMA</span>
    </a>
